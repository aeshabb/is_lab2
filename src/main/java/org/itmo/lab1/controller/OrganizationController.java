...
import org.itmo.lab1.service.OrganizationService;
import org.itmo.lab1.util.Page;
import org.itmo.lab1.util.PageRequest;
import org.itmo.lab1.util.Sort;
...
public class OrganizationController {
    ...
    public void initBinder(WebDataBinder binder) {
        // Подавляем стандартные ошибки Spring для Integer и Float
    ...
    public String index(@RequestParam(name = "page", defaultValue = "0") int page,
        ...
        if (filter != null && !filter.isEmpty()) {
            ...
            organizationsPage = new org.itmo.lab1.util.PageImpl<>(pageContent, pageRequest, sorted.size());
        } else {
